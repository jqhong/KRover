...
bool ConExecutor::BlockDispatch(Address S_Addr, struct pt_regs* m_regs)
{
    ...
    unsigned long BlockExec_Ret = (unsigned long)(BlockExecRIP + 0x7a);//End_T
    unsigned long BlockExec_CallBack = (unsigned long)(BlockExecRIP + 0x73);
    unsigned long* BlkExec_T_page = (unsigned long*)(BlockExecRIP + 0xf3);
    unsigned long* saved_rip_ptr = (unsigned long*)(BlockExecRIP + 0x103);
