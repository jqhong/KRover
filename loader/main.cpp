...
int main(void) {
    ...
    // return 0;
    // execState->MoniStartOfSE(0xffffffff81c00087);
    // execState->MoniStartOfSE(0xffffffff810b9440);//addr of x64_sys_setpriority
    // execState->MoniStartOfSE(0xffffffff81004202);//addr of indirect call in do_syscall_64 
