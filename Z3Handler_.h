...
public:
    ...
    // concritize function
    // bool Z3SolveConcretize(std::vector<SYMemObject*> symobjs, std::vector<unsigned int> values, std::set<KVExprPtr> constraints);
    bool Z3SolveConcretize(std::vector<VMState::SYMemObject*> symobjs, std::set<KVExprPtr> constraints);
